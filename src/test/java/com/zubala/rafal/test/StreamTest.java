...
public class StreamTest {
	...
	public void whenFindMax_thenGetMaxElementFromStream() {
	    ...
	    assertEquals(maxSalEmp.getSalary(), new Double(330000.0));
	}	
	...
	public void whenFindMaxOnIntStream_thenGetMaxInteger() {
	    Integer latestEmpId = empList.stream()
	      .mapToInt(Employee::getId)	//<-- IntStream not Stream<Integer>
	      .max()
	      .orElseThrow(NoSuchElementException::new);
	...
	public void whenApplySumOnIntStream_thenGetSum() {
	    Double avgSal = empList.stream()
	      .mapToDouble(Employee::getSalary) //<-- DoubleStream not Stream<Double>
	      .average()
	      .orElseThrow(NoSuchElementException::new);
	...
	public void whenApplyReduceOnStream_thenGetValue() {
	    ...
	    assertEquals(sumSal, new Double(660000));
	}
	...
	public void whenStreamReducing_thenGetValue() {
	    ...
	    assertEquals(salIncrOverhead, 66000.0, 0);
	}
